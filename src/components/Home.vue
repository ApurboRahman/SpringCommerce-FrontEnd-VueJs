<template>
  <div>
    ...
    <section class="hero-section">
      <div class>
        <div class="single-hero-items set-bg" data-set bg="../assets/img/hero-1.jpg">
          <div class="container">
            <div class="row">
              <div class="col-lg-5">
                <span>Bag,kids</span>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 offset-lg-1">
            <div
              ...
              data-setbg="../assets/img/products/man-large.jpg"
            >
              <h2>Men’s</h2>
              <a href="#">Discover More</a>
            </div>
    ...
    <div>
      <ul v-for="(item, i) in productLists" v-bind:key="i">
        <router-link :to="{path:'/productDetials/'+item.product_no}">{{item.product_name}}</router-link>
      </ul>
    </div>
  </div>
</template>
